...
## Demo:
Run the MCC generated code. While the button is pressed, the microcontroller will drive the output low, so the LED will be on. While the button is released, the LED will be turned off.
